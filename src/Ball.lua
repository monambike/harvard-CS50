...
function Ball:getRandomInitialDXDYVelocity()
  -- Returns a random initial DX and DY velocity for the ball
  return math.random(-200, 200), math.random(-50, -60)
end

function Ball:getRandomBallSkin()
