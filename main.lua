...
function love.load()
    ...
    gSounds = {
        ...
        ['powerup-1'] = love.audio.newSource('sounds/powerup-1.wav', 'static'),
        ['powerup-2'] = love.audio.newSource('sounds/powerup-2.wav', 'static'),
...
function renderKeyPowerup(showPowerup)
  if showPowerup then
    local powerupKey = VIRTUAL_WIDTH - 120
    love.graphics.draw(gTextures['main'], gFrames['powerups'][10], powerupKey, 2)
  end
end
