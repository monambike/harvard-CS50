...
function PipePair:init(y)
    ...
    local predefinedGaps = {90, 120, 160}
    local randomIndex = math.random(1, #predefinedGaps)
    local randomPredefinedValue = predefinedGaps[randomIndex]
    local gapHeight = randomPredefinedValue
